...
SETTING_KEY_GMAIL_SORT_SOURCE_LABEL = "gmail_sort_source_label"
SETTING_KEY_GMAIL_SORT_LABEL_TALENT = "gmail_sort_label_talent"
SETTING_KEY_GMAIL_SORT_LABEL_PROJECT = "gmail_sort_label_project"
SETTING_KEY_GMAIL_SORT_UNKNOWN_LABEL = "gmail_sort_unknown_label"
SETTING_KEY_GMAIL_SORT_KEYWORDS_TALENT = "gmail_sort_keywords_talent"
SETTING_KEY_GMAIL_SORT_KEYWORDS_PROJECT = "gmail_sort_keywords_project"
...
DEFAULT_SETTINGS: dict[str, Any] = {
    ...
    SETTING_KEY_GMAIL_SORT_SOURCE_LABEL: "SES未振り分け",
    SETTING_KEY_GMAIL_SORT_LABEL_TALENT: "SES人材紹介",
    SETTING_KEY_GMAIL_SORT_LABEL_PROJECT: "SES案件配信",
    SETTING_KEY_GMAIL_SORT_UNKNOWN_LABEL: "SES要確認",
    SETTING_KEY_GMAIL_SORT_KEYWORDS_TALENT: "人材\n要員\nスキルシート\nご紹介",
    SETTING_KEY_GMAIL_SORT_KEYWORDS_PROJECT: "案件\n募集\n開発\nお問い合わせ",
